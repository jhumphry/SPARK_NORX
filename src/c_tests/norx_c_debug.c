/*
   Adapted from the NORX reference source code package

   Modifications Copyright (c) 2016, James Humphry - see LICENSE file for details

   The original version had the following public domain dedication:
...
int main() {
    ...
    unsigned char n[32] = {0xF0,0xE0,0xD0,0xC0,0xB0,0xA0,0x90,0x80,0x70,0x60,0x50,0x40,0x30,0x20,0x10,0x00,0xF0,0xE0,0xD0,0xC0,0xB0,0xA0,0x90,0x80,0x70,0x60,0x50,0x40,0x30,0x20,0x10,0x00};
    ...
    printf("========== ENCRYPTION ==========\n");
    norx6441_aead_encrypt(c, &clen, a, alen, m, mlen, z, zlen, n, k);
    printf("Ciphertext + tag:\n");
    print_bytes(c, clen);

    printf("========== DECRYPTION ==========\n");
    result = norx6441_aead_decrypt(m, &mlen, a, alen, c, clen, z, zlen, n, k);
